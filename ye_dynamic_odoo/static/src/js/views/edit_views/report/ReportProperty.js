odoo.define('ye_dynamic_odoo.ReportProperty', function (require) {
"use strict";
    ...
    var ReportProperty = Base.PropertyBase.extend({
        ...
        preparePropertyNode: function (node) {
            let fieldNode = node.getAttribute("t-field"), escNode = node.getAttribute("t-esc"), widget = node.getAttribute("widget"),
                visibleIf = node.getAttribute("t-if"), lClass = this.getClassNode(node);
            let property = {visibleIf: visibleIf, fieldNode: fieldNode, escNode: escNode, widget: widget};
            const {el} = this.state;
        ...
        onChangeProperty: function (propertyChange) {
            ...
            if (name == "text") {
                ...
                node.setAttribute("widget", value);
            }
            if (saveTemplate) {
                saveTemplate();
            }
